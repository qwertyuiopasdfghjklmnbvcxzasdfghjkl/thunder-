  ...
  <div >
    <div class="type_symbol">
      <div class="type_symbol_wrap">
        <ul>
          <router-link :to="{name: 'exchange_index',params:{symbol:item.currencySymbol+'_'+item.baseSymbol}}" v-for="(item, index) in products" :key="index" tag="li">
            <div class="currency">
...
<style scoped>
  ...
  .type_symbol ul li{font-size: 14px; padding: 20px 10px 40px;width: 20%;text-align: left; border-right: 1px solid #fff; box-sizing: border-box;}
  ...
  .type_symbol ul li {cursor: pointer;}
