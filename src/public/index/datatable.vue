  ...
  export default {
    ...
    computed: {
      ...
      markets () {
        ...
        return [...new Set(this.products.map(item=>{return item.baseSymbol}))].sort().slice(0,5)
      },
      /* 选中数据的集合 */
...
.layui-tab-title li{display: inline-block; vertical-align: middle; font-size: 16px; transition: all .2s; -webkit-transition: all .2s; position: relative; line-height: 54px; min-width: 120px; padding: 0 10px; text-align: center; cursor: pointer; color: #5a5a5a; box-sizing: border-box; max-width: 450px; overflow: hidden; text-overflow: ellipsis;}
