                ...
                <div class="login-right-item item-register">
                    ...
                    <div class="checkbox-group">
                        ...
                        <span>
                          ...
                          <a :href="getAgreementUrl" target="_blank">{{$t('login_register.bitark_service').format('BILE')}}<!--BILE服务条款--></a>
                        </span>
                    </div>
                    <div class="button-group">
                        <buttonbox :class="{disabled:locked||gtLocked}" :text="$t('login_register.register')" @click="register"/><!--注册-->
                        <div class="link">
                            <a href="javascript:;" @click="loginDialog" v-html="$t('login_register.Already_registered_Login').format(`<font color='#3A76E7'>BILE</font>`)"><!--已有BILE账号，请登录--></a>
                        </div>
                    </div>
                </div>
            </div>
...
.item-registerType{ margin: auto; display: flex; color: #0472E9; font-size: 18px; padding-bottom: 20px;}
