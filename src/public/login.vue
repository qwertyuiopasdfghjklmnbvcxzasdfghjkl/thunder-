        ...
        <div class="login-container">
            ...
            <div class="login-right">
                <div class="login-right-item item-login">
                    <div class="caption">{{$t('login_register.title_login').format('BILE')}}<!--欢迎来到BILE--></div>
                    <div class="prompt">
                        <i>!</i>
                        <span>{{$t('login_register.warm_prompt')}}<!--请确认您正在访问：-->www.bileex.com</span>
                    </div>
...
.login-right-item /deep/ .input{
  width: 100% !important;height: 40px;margin: 0;font-size: 16px;line-height: normal;
  color: #555;background-color: #fff; border-bottom: 1px solid #DFDFDF;outline: none;
}
.login-right-item /deep/ .input:focus{background-color: transparent;border-bottom-color:#3A76E7!important; outline: none;}
...
.login-right-item .button-group .link a{height: 24px;line-height: 24px;color: #3368DA;text-decoration: underline;}
...
.login-right-item .button-group .link a:hover{color: #3368DA;}
.third-login {line-height: 20px; margin-top: 30px;}
.third-login i { display: inline-block; width: 20px; height: 20px; overflow: hidden; background-size: contain; background-repeat: no-repeat;background-position: center; vertical-align: middle;}
.third-login .enjoy {background-image: url('../assets/images/ico-enjoy.png');}
.third-login span {cursor: pointer;}
</style>
