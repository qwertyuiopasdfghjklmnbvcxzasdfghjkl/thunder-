    ...
    <div class="business-panel" :class="{unfold:isShow}">
        ...
        <div class="business-panel-form" v-show="isShow">
            <div class="business-panel-left">
                <business ref="business_buy" :active="active" tradeType="buy" :fixedNumber="fixedNumber" :Quantityaccu="Quantityaccu" :Amountaccu="Amountaccu" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :fromWallet="fromWallet" :toWallet="toWallet" :marketList="marketList"/>
            </div>
            <div class="business-panel-right">
                <business ref="business_sell" :active="active" tradeType="sell" :fixedNumber="fixedNumber" :Quantityaccu="Quantityaccu" :Amountaccu="Amountaccu" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :fromWallet="fromWallet" :toWallet="toWallet" :marketList="marketList"/>
            </div>
        </div>
    </div>
</template>
...
export default {
  props: ['fixedNumber','Quantityaccu','Amountaccu', 'baseSymbol', 'currentSymbol', 'fromWallet', 'toWallet','marketList'],
  components: {
    business
  },
  data () {
