...
.tabs{margin-top:6px;display:flex; flex-wrap: wrap; padding-bottom: 5px;border-bottom:1px solid #7E7E7E; }
.tabs-item{position:relative;height:22px;font-size:16px;line-height:22px;color:#666;text-align:center; cursor:pointer;}
.tabs-item + .tabs-item {margin-left: 10px;}
.tabs-item:hover,
