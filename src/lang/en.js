export default {
		...
		"vote": {
			...
			"rule_3_4": "When the number of ETVs for trading reaches the requirements, it will take 1-6 hours to issue the reward;",
			...
			"rule_1_1": "The currency with the highest vote will be listed on ETV;",
			"rule_1_4": "ETVCOIN reserves the right of final interpretation of the event, including the handling of ticket swiping;",
			"rule_3_2": "After the mapping is successful, your address will form a parallel chain binding with the ETV relay chain. If you need to cancel or replace, please contact ETVCOIN customer service staff；",
		...
		"error_code": {
			...
			"NOT_HOLDING_CARD_AS_REQUIRED": "Hand written ETVCOIN and date cards without request.",
		...
		"ErrorCode": {
			"QUANTITY_MUST_BE_100_MULTIPLE": "The quantity must be a multiple of 100"
		},
		"user": {
			"msg": "Message",
			"submit": "Submit",
		...
		"account": {
			...
			"my_stake_tip2": "After the mapping is successful, your address will form a parallel chain binding with the ETV relay chain. If you need to cancel or replace, please contact ETVCOIN customer service staff；",
